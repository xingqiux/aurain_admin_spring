package top.xkqq.product.controller.test;
...
import top.xkqq.product.service.FileUploadService;
...
public class TestServiceController {
    ...
    public Result<String> testFileUpload() {
        return Result.build(fileUploadService.fileUpload(null), ResultCodeEnum.SUCCESS);
    }
